...
public static class SeedHelper
{
	...
	private static async Task AddIngredients(DataContext dataContext)
	{
		...
		dataContext.Set<Ingredient>().AddRange(
			new Ingredient { Name = "Whole Milk", Type = "Coffee", IsAllergen = true },
			new Ingredient { Name = "2% Milk", Type = "Coffee", IsAllergen = true },
			new Ingredient { Name = "Skim Milk", Type = "Coffee", IsAllergen = true },
			new Ingredient { Name = "Oat Milk", Type = "Coffee", IsAllergen = false },
			new Ingredient { Name = "Almond Milk", Type = "Coffee", IsAllergen = true },
			new Ingredient { Name = "Soy Milk", Type = "Coffee", IsAllergen = true },
			new Ingredient { Name = "Half & Half", Type = "Coffee", IsAllergen = true },
			new Ingredient { Name = "Heavy Cream", Type = "Coffee", IsAllergen = true },
            new Ingredient { Name = "Sugar", Type = "Coffee", IsAllergen = false },
			new Ingredient { Name = "Brown Sugar", Type = "Coffee", IsAllergen = false },
			new Ingredient { Name = "Honey", Type = "Coffee", IsAllergen = false },
			new Ingredient { Name = "Stevia", Type = "Coffee", IsAllergen = false },
			new Ingredient { Name = "Vanilla Syrup", Type = "Coffee", IsAllergen = false },
			new Ingredient { Name = "Caramel Syrup", Type = "Coffee", IsAllergen = false },
			new Ingredient { Name = "Hazelnut Syrup", Type = "Coffee", IsAllergen = false },
			new Ingredient { Name = "Chocolate Syrup", Type = "Coffee", IsAllergen = false },
			new Ingredient { Name = "Whipped Cream", Type = "Coffee", IsAllergen = true },
			new Ingredient { Name = "Ice", Type = "Coffee", IsAllergen = false },

			new Ingredient { Name = "Plain Bagel", Type = "Bagel", IsAllergen = true },
			new Ingredient { Name = "Everything Bagel Seasoning", Type = "Bagel", IsAllergen = false },
			new Ingredient { Name = "Cream Cheese", Type = "Bagel", IsAllergen = true },
			new Ingredient { Name = "Strawberry Cream Cheese", Type = "Bagel", IsAllergen = true },
			new Ingredient { Name = "Butter", Type = "Bagel", IsAllergen = true },
			new Ingredient { Name = "Bacon", Type = "Bagel", IsAllergen = false },
			new Ingredient { Name = "Egg", Type = "Bagel", IsAllergen = true },

			new Ingredient { Name = "Crepe Batter", Type = "Crepe", IsAllergen = true },
			new Ingredient { Name = "Nutella", Type = "Crepe", IsAllergen = true },
			new Ingredient { Name = "Strawberries", Type = "Crepe", IsAllergen = false },
			new Ingredient { Name = "Bananas", Type = "Crepe", IsAllergen = false },
			new Ingredient { Name = "Blueberries", Type = "Crepe", IsAllergen = false },
			new Ingredient { Name = "Powdered Sugar", Type = "Crepe", IsAllergen = false },
			new Ingredient { Name = "Whipped Cream", Type = "Crepe", IsAllergen = true },
			new Ingredient { Name = "Chocolate Chips", Type = "Crepe", IsAllergen = true }
        );
